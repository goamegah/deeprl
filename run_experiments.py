...
AGENT_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "tictactoe": {
        ...
        "ExpertApprentice_BC":        lambda: ExpertApprenticeAgent(state_dim=27, n_actions=9, expert=MCTSExpert(n_simulations=100), mode="bc", hidden_dims=[128, 128], lr=1e-3),
        "ExpertApprentice_DAgger":    lambda: ExpertApprenticeAgent(state_dim=27, n_actions=9, expert=MCTSExpert(n_simulations=100), mode="dagger", hidden_dims=[128, 128], lr=1e-3),
    },
    "quarto": {
        ...
        "DoubleDeepQLearningWithPER": lambda: DQNAgent(state_dim=114, n_actions=16, hidden_dims=[256, 256], lr=1e-3, gamma=0.99, double_dqn=True, use_replay=True, prioritized=True, alpha=0.3, buffer_size=5000, batch_size=64, min_buffer_size=1000),
